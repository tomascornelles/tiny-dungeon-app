...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.esm.js"}],"../../../../../usr/local/lib/node_modules/parcel/node_modules/process/browser.js":[function(require,module,exports) {
    ...
    return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
      ...
      return (0, _tslib.__generator)(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            _a = _tslib.__read.apply(void 0, [_b.sent(), 2]), authToken = _a[0], appCheckToken = _a[1];
...
function connectDatabaseEmulator(db, host, port, options) {
  ...
  if (repo.repoInfo_.nodeAdmin) {
    ...
    var token = (0, _util.createMockUserToken)(options.mockUserToken, db.app.options.projectId);
...
},{"@firebase/database":"../node_modules/@firebase/database/dist/index.esm.js"}],"scripts/db.js":[function(require,module,exports) {
"use strict";
...
exports.setValue = exports.getList = exports.getValue = void 0;
...
var getValue = function getValue(params) {
  ...
  _app.default.database().ref(ref).once('value', function (snapshot) {
    callback({
      'selector': element,
      'prop': prop,
      'value': snapshot.val(),
...
var getList = function getList(params) {
  ...
  _app.default.database().ref(ref).once('value', function (snapshot) {
    snapshot.val().map(function (item) {
      return callback({
        'selector': element,
        'prop': prop,
        'value': snapshot.val(),
...
var setValue = function setValue(event) {
  ...
  var updates = _defineProperty({}, event.target.dataset.ref, event.target.value);

  _app.default.database().ref().update(updates);
};

exports.setValue = setValue;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/database":"../node_modules/firebase/database/dist/index.esm.js"}],"scripts/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderList = exports.render = exports.listener = exports.selector = void 0;

var _db = require("./db");

var selector = function selector(params) {
  var selector = params.selector,
      prop = params.prop,
      value = params.value,
      data = params.data;
  document.querySelectorAll(selector).forEach(function (item) {
    if (data) item.dataset[prop] = value;else item[prop] = value;
    if (prop === 'value') listener({
      'selector': selector,
      'event': 'change',
      'callback': _db.setValue
    });
  });
};
...
var listener = function listener(params) {
  var selector = params.selector,
      event = params.event,
      callback = params.callback;
  document.querySelectorAll(selector).forEach(function (item) {
...
var render = function render(params) {
  return (0, _db.getValue)(params);
};

exports.render = render;

var renderList = function renderList(params) {
  return GeolocationPosition(params);
};

exports.renderList = renderList;
},{"./db":"scripts/db.js"}],"views/home.js":[function(require,module,exports) {
"use strict";
...
var _default = home;
exports.default = _default;
},{"../scripts/utils":"scripts/utils.js"}],"scripts/router.js":[function(require,module,exports) {
"use strict";
...
var Router = /*#__PURE__*/function () {
  ...
  _createClass(Router, [{
    ...
    value: function initRouter() {
      ...
      var URI = pathname === "/" ? "home" : pathname.replace("/", "");
      this.load(URI);
    }
    /**
    ...
    value: function load() {
      ...
      var dest = route.length === 1 && route[0] !== 'home' ? 'campaign' : route.length === 2 ? 'pc' : 'home';
      var campaignId = route[0];
      var pcId = route.length === 2 ? route[1] : null;
      var paths = this.paths;

      var _ref = paths[dest] || paths.error,
          template = _ref.template;

      var $CONTAINER = document.querySelector("#app");
      $CONTAINER.innerHTML = template(campaignId, pcId);
      window.history.pushState({}, "Genial", "/".concat(page));
    }
  }]);
...
},{"../views/home":"views/home.js"}],"views/campaign.js":[function(require,module,exports) {
"use strict";
...
var _db = require("../scripts/db");

var campaign = function campaign(id) {
  var template = "\n    <h1>CAMPA\xD1A ".concat(id, "</h1>\n    <p class=\"js-name\"></p>\n    ");
  (0, _db.getValue)("/campaigns/".concat(id, "/title"), '.js-name', 'innerHTML');
  return template;
};

var _default = campaign;
exports.default = _default;
},{"../scripts/db":"scripts/db.js"}],"views/pc.js":[function(require,module,exports) {
"use strict";
...
var pc = function pc(campaignId, pcId) {
  var template = "\n  <h1>PERSONAJE ".concat(pcId, " for ").concat(campaignId, "</h1>\n  <p><strong>Name</strong>: <span class=\"js-name\"></span></p>\n  <p><strong>F\xEDsico</strong>: <span class=\"js-phisical\"></span></p>\n  <p><strong>Mental</strong>: <span class=\"js-mental\"></span></p>\n  <p><strong>Social</strong>: <span class=\"js-social\"></span></p>\n  ");
  var ref = "/campaigns/".concat(campaignId, "/pcs/").concat(pcId, "/");
  (0, _utils.render)({
    'ref': "".concat(ref, "/name"),
    'element': '.js-name',
    'callback': _utils.selector,
...
var _default = pc;
exports.default = _default;
},{"../scripts/utils":"scripts/utils.js","firebase/app":"../node_modules/firebase/app/dist/index.esm.js","../scripts/db":"scripts/db.js"}],"scripts/routes.js":[function(require,module,exports) {
"use strict";
...
var _campaign = _interopRequireDefault(require("../views/campaign"));

var _pc = _interopRequireDefault(require("../views/pc"));
...
var PATHS = {
  ...
  campaign: {
    path: "/campaign",
    template: _campaign.default
  },
  pc: {
    path: "/pc",
    template: _pc.default
  }
};
var _default = PATHS;
exports.default = _default;
},{"../views/home":"views/home.js","../views/campaign":"views/campaign.js","../views/pc":"views/pc.js"}],"scripts/app.js":[function(require,module,exports) {
"use strict";
...
var ROUTER = new _router.default(_routes.default);
document.querySelectorAll('.js-link').forEach(function (link) {
  link.addEventListener('click', function () {
    ROUTER.load(link.dataset.to);
  });
});
},{"./router":"scripts/router.js","./routes":"scripts/routes.js"}],"../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","scripts/app.js"], null)
